...
| ------------------------ | ---------------------------- | ------------------------ | ------------------------------- | ------------- |
| **1. Local Dev (HTTP)**  | `docker-compose.yml`         | http://localhost:5173    | Daily development, hot reload   | None          |
...
- `docker-compose.yml` - Local development (HTTP, hot reload, Vite proxy)
- `docker-compose.dev-ssl.yml` - Local development (HTTPS with self-signed certs, hot reload)
- `docker-compose.prod.yml` - Local production testing (HTTP, nginx proxy)
