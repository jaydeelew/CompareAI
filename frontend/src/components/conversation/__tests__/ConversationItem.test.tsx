...
describe('ConversationItem', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should display date', () => {
      ...
      const dateElement = screen.getByText(/just now|ago|yesterday|jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec/i);
  ...
  describe('User Interactions', () => {
    it('should call onClick when clicked', async () => {
      ...
      render(
        <ConversationItem conversation={mockConversation} onClick={handleClick} />
      );
