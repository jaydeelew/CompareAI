 ...
 */
export const mockCompare = vi.fn<[CompareRequestPayload], Promise<ReturnType<typeof mockCompareResponse>>>(
  async (payload) => {
 ...
 */
export const mockCompareStream = vi.fn<[CompareRequestPayload], Promise<ReadableStream<Uint8Array> | null>>(
  async (payload) => {
 ...
 */
export const mockGetModelStats = vi.fn<[], Promise<ModelStats>>(
  async () => {
 ...
 */
export const mockLogin = vi.fn<[LoginCredentials], Promise<AuthResponse>>(
  async (credentials) => {
 ...
 */
export const mockRegister = vi.fn<[RegisterData], Promise<AuthResponse>>(
  async (data) => {
 ...
 */
export const mockRefreshToken = vi.fn<[string], Promise<{ access_token: string; refresh_token: string; token_type: string }>>(
  async (refreshToken) => {
    return {
 ...
 */
export const mockGetCurrentUser = vi.fn<[], Promise<User>>(
  async () => {
 ...
 */
export const mockVerifyEmail = vi.fn<[string], Promise<{ message: string }>>(
  async (token) => {
 ...
 */
export const mockForgotPassword = vi.fn<[string], Promise<{ message: string }>>(
  async (email) => {
 ...
 */
export const mockLogout = vi.fn<[], Promise<{ message: string }>>(
  async () => {
 ...
 */
export const mockDeleteAccount = vi.fn<[], Promise<{ message: string }>>(
  async () => {
 ...
 */
export const mockGetConversations = vi.fn<[], Promise<ConversationSummary[]>>(
  async () => {
 ...
 */
export const mockGetAvailableModels = vi.fn<[], Promise<AvailableModelsResponse>>(
  async () => {
 ...
 * ```
 */
export function createMockServiceModule<T extends Record<string, unknown>>(
  mocks: T
): T {
  return mocks;
}
