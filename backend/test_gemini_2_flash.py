#!/usr/bin/env python3
"""
Test specific Gemini 2.0 Flash model ID variations
"""
import os
...
# Test specific Gemini 2.0 Flash variations
test_model_ids = [
...
print("Testing Gemini 2.0 Flash variations...")
print("=" * 60)

working_models = []
for model_id in test_model_ids:
    print(f"Testing: {model_id:<50}", end=" ")
...
print("\n" + "=" * 60)
if working_models:
    print("Working Gemini 2.0 Flash model IDs:")
    for model in working_models:
        print(f"  ✅ {model}")
else:
    print("❌ No working Gemini 2.0 Flash model IDs found")
