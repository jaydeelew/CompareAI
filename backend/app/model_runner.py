...
MODELS_BY_PROVIDER = {
    "Anthropic": [
        ...
        },
        {
            ...
            "description": "Anthropic's Claude 3.7 Sonnet model with enhanced performance",
            "category": "Language",
            "provider": "Anthropic",
        },
        {
    ...
    "Cohere": [
        {
            ...
            "name": "Command R7B",
            "description": "Cohere's compact model with excellent efficiency and performance",
            "category": "Language",
            "provider": "Cohere",
        },
        {
        ...
        },
        {
            "id": "cohere/command-a",
            "name": "Command A",
            "description": "Cohere's Command A model for general language tasks",
            "category": "Language",
            "provider": "Cohere",
        },
    ],
    "DeepSeek": [
        {
            ...
            "description": "DeepSeek's experimental V3.2 model with cutting-edge capabilities",
            "category": "Language/Reasoning",
            "provider": "DeepSeek",
        },
        {
    ...
    "Google": [
        ...
        },
        {
            ...
            "description": "Google's preview version of Gemini 2.5 Flash from September 2025",
            "category": "Language",
            "provider": "Google",
        },
        {
            ...
            "description": "Google's lightweight Gemini 2.5 Flash model optimized for efficiency",
            "category": "Language",
            "provider": "Google",
        },
        {
    ...
    "Meta": [
        ...
        },
        {
            ...
            "description": "Meta's optimized Llama 4 model for rapid deployment - free tier",
            "category": "Language",
            "provider": "Meta",
        },
        {
        ...
        },
        {
            ...
            "description": "Meta's flagship Llama 4 model with advanced reasoning - free tier",
        ...
        },
        {
            ...
            "description": "Meta's Llama 3.3 with text and code generation - free tier",
            "category": "Code/Language",
            "provider": "Meta",
        },
        {
    ...
    "Microsoft": [
        ...
        },
        {
            ...
            "name": "MAI-DS-R1 (Free)",
            "description": "Microsoft's MAI-DS-R1 reasoning model - free tier",
            "category": "Reasoning",
            "provider": "Microsoft",
        },
    ],
    "Mistral": [
        ...
        },
        {
            ...
            "description": "Mistral's balanced medium model with strong capabilities",
            "category": "Language",
            "provider": "Mistral",
        },
        {
        ...
        },
        {
            ...
            "name": "Devstral Small",
            "description": "Mistral's small development-focused model for coding tasks",
            "category": "Code",
            "provider": "Mistral",
        },
        {
            ...
            "description": "Mistral's medium development-focused model for advanced coding",
            "category": "Code",
            "provider": "Mistral",
        },
        {
            ...
            "name": "Codestral 2508",
            "description": "Mistral's specialized code model from August 2025",
            "category": "Code",
            "provider": "Mistral",
        },
    ],
    "OpenAI": [
        {
            "id": "openai/gpt-5-pro",
            "name": "GPT-5 Pro",
            "description": "OpenAI's professional-tier GPT-5 model with enhanced capabilities",
            "category": "Language",
            "provider": "OpenAI",
        },
        {
            ...
            "name": "GPT-5 Nano",
            "description": "OpenAI's ultra-lightweight GPT-5 model optimized for efficiency",
            "category": "Language",
            "provider": "OpenAI",
        },
        {
        ...
        },
        {
            ...
            "name": "GPT-5 Codex",
            "description": "OpenAI's GPT-5 Codex specialized for code generation and programming tasks",
            "category": "Code",
            "provider": "OpenAI",
        },
        {
            ...
            "name": "GPT-5 Chat",
            "description": "OpenAI's GPT-5 Chat optimized for conversational interactions",
            "category": "Language",
            "provider": "OpenAI",
        },
        {
    ...
    "Qwen": [
        {
            ...
            "description": "Qwen's vision-language model with thinking capabilities",
        ...
        },
        {
            ...
            "description": "Qwen's next-generation 80B model with enhanced thinking capabilities",
            "category": "Language/Reasoning",
            "provider": "Qwen",
        },
        {
            ...
            "description": "Qwen's next-generation 80B instruction-following model",
            "category": "Language",
            "provider": "Qwen",
        },
        {
            "id": "qwen/qwen3-max",
            "name": "Qwen3 Max",
            "description": "Qwen's maximum capability model with top performance",
            "category": "Language",
            "provider": "Qwen",
        },
        {
            ...
            "description": "Qwen's enhanced code model with advanced programming capabilities",
            "category": "Code",
            "provider": "Qwen",
        },
        {
            ...
            "description": "Qwen's fast code model optimized for speed",
            "category": "Code",
            "provider": "Qwen",
        },
        {
        ...
        },
        {
            ...
            "description": "Qwen's 30B instruction model from July 2025",
            "category": "Language",
            "provider": "Qwen",
        },
        {
            ...
            "description": "Qwen's 235B thinking model from July 2025",
            "category": "Language/Reasoning",
            "provider": "Qwen",
        },
        {
    ...
    "xAI": [
        {
            "id": "x-ai/grok-4-fast",
            "name": "Grok 4 Fast",
            "description": "xAI's fast Grok 4 model optimized for speed",
            "category": "Language",
            "provider": "xAI",
        },
        {
        ...
        },
        {
            "id": "x-ai/grok-3-mini",
            "name": "Grok 3 Mini",
            "description": "xAI's compact Grok 3 model for efficient processing",
            "category": "Language",
            "provider": "xAI",
        },
        {
            "id": "x-ai/grok-3",
            "name": "Grok 3",
            "description": "xAI's Grok 3 model with advanced reasoning capabilities",
            "category": "Language",
            "provider": "xAI",
        },
    ],
