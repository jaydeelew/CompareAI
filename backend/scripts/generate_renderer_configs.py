...
class ConfigGenerator:
    ...
    def validate_config(self, config: Dict[str, Any]) -> List[str]:
        ...
        if not config.get('displayMathDelimiters') or not isinstance(config['displayMathDelimiters'], list):
            errors.append('Missing or invalid displayMathDelimiters')
        
        if not config.get('inlineMathDelimiters') or not isinstance(config['inlineMathDelimiters'], list):
    ...
    def generate_configs(self, analysis_data: Dict[str, Any]) -> List[Dict[str, Any]]:
...
def main():
    ...
    configs = generator.generate_configs(analysis_data)
